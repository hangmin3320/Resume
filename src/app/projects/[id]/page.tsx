              ...
              <div>
                ...
                <div className="flex space-x-4">
                  {project.id !== '3' ? (
                    ...
                    <a href="https://gpt.aiia-gcu.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">서비스 바로가기</a>
                  )}
                </div>
              </div>
            </div>
